...
class STetromino extends Tetromino{
  ...
  STetromino(TetrisGame model) : super(model, [
    { 'row' : 1, 'col' : model.sizeWidth ~/ 2 - 2  },
    { 'row' : 1, 'col' : model.sizeWidth ~/ 2 - 1  },
    { 'row' : 0, 'col' : model.sizeWidth ~/ 2 - 1  },
    { 'row' : 0, 'col' : model.sizeWidth ~/ 2      }
  ], [
    { 'row' : 2, 'col' : model.extraFieldWidth ~/ 2     },
    { 'row' : 2, 'col' : model.extraFieldWidth ~/ 2 - 1 },
    { 'row' : 1, 'col' : model.extraFieldWidth ~/ 2 - 1 },
    { 'row' : 1, 'col' : model.extraFieldWidth ~/ 2 - 2 }
  ], #green){
    _state = 0;
    _numberOfStates = 4;
    _transitions = [
      [[-1, 0], [0, -1], [1, 0], [2, -1]], //t0: s0 -> s1
      [[1, 0], [0, 1], [-1, 0], [-2, 1]], //t1: s1 -> s2
      [[-1, 0], [0, -1], [1, 0], [2, -1]], //t2: s2 -> s0
      [[1, 0], [0, 1], [-1, 0], [-2, 1]]
    ];
  }
